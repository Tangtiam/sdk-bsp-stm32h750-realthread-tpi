...
rt_err_t dlmodule_load_shared_object(struct rt_dlmodule* module, void *module_ptr)
{
    ...
    /* set module entry */
    module->entry = module->mem_space + elf_module->e_entry - vstart_addr;
...
rt_err_t dlmodule_load_relocated_object(struct rt_dlmodule* module, void *module_ptr)
{
    ...
    /* set module entry */
    module->entry = (rt_dlmodule_entry_func_t)((rt_uint8_t *)module->mem_space + elf_module->e_entry - module_addr);
